...
namespace Exceptions
{
    public class ExceptionManager
    {
        ...
        public string PATH = @"C:\perflogs\";

        private static ExceptionManager instance;

        private static Dictionary<int, Lw.ApplicationMessages.ApplicationMessage> messages = new Dictionary<int, ApplicationMessage>();
        ...
        public ApplicationMessage GetMessage(BussinessException bex)
        {
           //if (messages.ContainsKey(bex.ExceptionId))
            ...
            if (messages.ContainsKey(bex.ExceptionId))
            {
                return messages[bex.ExceptionId];
            }
            return null;
